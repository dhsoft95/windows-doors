            ...
            <div class="col-lg-6">
                <div class="about-us-content">
                    ...
                    <div class="section-title">
                        ...
                        <h2 class="text-anime-style-3" data-cursor="-opaque">Quality and Design Excellence in Doors & Windows</h2>
                        <p class="wow fadeInUp" data-wow-delay="0.2s">Simba Doors and Windows Ltd is a fast-growing company with over 30 years of experience in delivering high-quality designed doors and windows. We keep design and creativity at the heart of everything we do, ensuring each project reflects our commitment to excellence.</p>
                    </div>
                    <!-- Section Title End -->
